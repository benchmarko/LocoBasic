...
REM
MODE 1
INK 0,0:INK 1,26:INK 2,14:INK 3,6:PAPER 0:MODE 1
'PRINT"Johann Sebastian Bach" 
'
'Organ case
'
FOR kz=1 TO 2:READ kc,kd:PLOT kc,kd,1:FOR kn=1 TO 35:READ ka,kb:DRAWR ka,kb,1:NEXT kn,kz
'
...
FOR ke=0 TO 10 STEP 2:PLOT 98+ke,252+ke,1:DRAW 200,252+ke,1:NEXT  
FOR kf=0 TO 10 STEP 2:PLOT 514-kf,250+kf,1:DRAW 410,250+kf,1:NEXT 
'
'Organ pipes
'
FOR pf=1 TO 29:READ wdth,px,py,height,yfu
FOR a=px TO px+wdth:PLOT a,py,2:DRAWR 0,height:PLOT px+wdth/2,yfu:DRAW a,py,2:PLOT a,py,3:DRAWR 0,10,3:PLOT a,py+5,0:NEXT a,pf
'
