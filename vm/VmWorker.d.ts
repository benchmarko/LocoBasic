...
export declare const workerFn: (parentPort: NodeWorkerThreadsType["parentPort"] | BrowserWorkerThreadsType["parentPort"]) => {
    ...
    formatCommaOrTab: (str: string | undefined) => string;
    formatNumber1: (arg: number) => string;
    formatNumberArgs: (args: (string | number | undefined)[]) => (string | undefined)[];
    ...
    asc: (str: string | undefined) => number;
    ...
    dec$: (num: number, format: string | undefined) => string;
    ...
    instr: (str: string | undefined, find: string | undefined, len: number) => number;
    int: (num: number) => number;
    keyDef: (num: number, repeat: number, ...codes: number[]) => void;
    left$: (str: string | undefined, num: number) => string;
    len: (str: string | undefined) => number;
    lineInput: (prompt: string) => Promise<string>;
    log: (num: number) => number;
    log10: (num: number) => number;
    lower$: (str: string | undefined) => string;
    max: (...nums: number[]) => number;
    mid$: (str: string | undefined, pos: number, len?: number) => string;
    mid$Assign: (s: string | undefined, start: number, newString: string | undefined, len?: number) => string;
    ...
    pos: () => number;
    print: (...args: (string | number | undefined)[]) => void;
    printTag: (...args: (string | number | undefined)[]) => void;
    printTab: (...args: (string | number | undefined)[]) => void;
    printTabTag: (...args: (string | number | undefined)[]) => void;
    printText: (text: string) => void;
    read: () => string | number;
    remain: (timer: number) => number;
    remainAll: () => void;
    restore: (label: string) => void;
    right$: (str: string | undefined, num: number) => string;
    rnd: () => number;
    ...
    string$Str: (len: number, str: string | undefined) => string;
    tan: (num: number) => number;
    time: () => number;
    toDeg: (num: number) => number;
    toRad: (num: number) => number;
    usingOne(tok: string, arg: string | number): string;
    using: (format: string | undefined, ...args: (string | number)[]) => string;
    unt: (num: number) => number;
    upper$: (str: string | undefined) => string;
    val1: (str: string) => number;
    val: (str: string | undefined) => number;
    vpos: () => number;
    write: (...args: (string | number | undefined)[]) => void;
    writeTag: (...args: (string | number | undefined)[]) => void;
    xpos: () => number;
    ypos: () => number;
