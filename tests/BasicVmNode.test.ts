...
const getMockVmCore = () => {
    return {
        ...
        setOutput: vi.fn(),
        getFlushedGraphics: vi.fn().mockReturnValue(''),
        graphicsPen: vi.fn(),
        ink: vi.fn(),
        mode: vi.fn(),
        origin: vi.fn(),
...
describe('BasicVmNode Module', () => {
    ...
    describe('BasicVmNode', () => {
       ...
       const getMocks = () => {
            ...
            // Mocking the BasicVmCore constructor
            //vi.spyOn(BasicVmCore, 'BasicVmCore').mockImplementation(() => mockVmCore);
        ...
        it('should flush graphics output', () => {
            const {basicVmNode, mockVmCore} = getMocks();
            mockVmCore.getFlushedGraphics.mockReturnValue('Graphics Output');
            const printSpy = vi.spyOn(console, 'log').mockImplementation(() => {});
    ...
    // Add specific tests for BasicVmNode module functions here
});